...
Object.defineProperties(Iterator.prototype, {
    ...
    indexOutOfBounds: {
        value: function indexOutOfBounds() {
            if (this.currentRow >= 0 && this.currentCol >= 0 && this.currentRow < this.board.rowCount && this.currentCol < this.board.columnCount) {
                return false;
            }
            else {
                return true;
...
Iterator.prototype.MoveNextDiagonal = function () {
    ...
    do {
        this.currentCol += this.colOffset;
        if ((this.type == Iterator.TYPE_DIAG_LEFTTORIGHT_FORWARD) || (this.type == Iterator.TYPE_DIAG_RIGHTTOLEFT_FORWARD)) {
