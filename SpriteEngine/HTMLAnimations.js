...
function HeightAnimation(sprite, currentHeight, targetHeight, delay, duration, callbackComplete) {
...
Object.defineProperties(HeightAnimation.prototype, {
    updateCore: {
        value: function updateCore(offset) {
            this.sprite.style.height = (this.startHeight + (this.deltaHeight * offset)) + "px";
        }
    }
});

function WidthAnimation(sprite, currentWidth, targetWidth, delay, duration, callbackComplete) {
    Animation.call(this, sprite, delay, duration, callbackComplete);
...
Object.defineProperties(WidthAnimation.prototype, {
    updateCore: {
        value: function updateCore(offset) {
            this.sprite.style.width = (this.startWidth + (this.deltaWidth * offset)) + "px";
        }
    }
});

function CSSOpacityAnimation(sprite, startOpacity, endOpacity, delay, duration, callbackComplete) {
    Animation.call(this, sprite, delay, duration, callbackComplete);
...
Object.defineProperties(CSSOpacityAnimation.prototype, {
    updateCore: {
        value: function updateCore(offset) {
            this.sprite.style.opacity = (this.startOpacity + (this.deltaOpacity * offset));
        }
    }
});
