...
function JingleBallsConnect3Engine(
  boardSprite,
  boardRowCount,
  boardColumnCount,
  pieceSize,
...
JingleBallsConnect3Engine.prototype = Object.create(
  CanvasConnect3Engine.prototype
);
...
Object.defineProperties(JingleBallsConnect3Engine.prototype, {
  createPiece: {
    value: function createPiece(col, row, board) {
      ...
      return CanvasConnect3Engine.prototype.createPiece.call(
        this,
        col,
        row,
        board
  ...
  processPieces: {
    value: function processPieces(pieceArray, cascadeCount) {
      ...
      return CanvasConnect3Engine.prototype.processPieces.call(
        this,
        pieceArray,
        cascadeCount
      );
